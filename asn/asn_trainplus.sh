...
JOB_PREFIX="AssemblenetPlus"
MODEL_DIR=${GCS_MODEL_DIR}/${JOB_PREFIX}_${NOW}
python -m official.vision.beta.projects.assemblenet.train --mode=train_and_eval --experiment=assemblenetplus_ucf101 --model_dir=${MODEL_DIR}  --config_file=./asn/asnplus.yaml --tpu=node-3
