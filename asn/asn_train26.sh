...
JOB_PREFIX="Assemblenet26"
MODEL_DIR=${GCS_MODEL_DIR}/${JOB_PREFIX}_${NOW}
python -m official.vision.beta.projects.assemblenet.train --mode=train_and_eval --experiment=assemblenet_ucf101 --model_dir=${MODEL_DIR}  --config_file=./asn/assemble26.yaml --tpu=node-2
